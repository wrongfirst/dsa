...
`)}_({async init(){await S()},async execute(t,n=``){await S();let r=!!x,i=C(t,n,!r),a=``,o=new TextDecoder(`utf-8`),s=[`clang`,`-O0`,`-Wall`,`-Wno-unused-variable`,`-Wno-unused-function`],c={"main.c":i};r&&x&&(s.push(`-include-pch`,`harness.pch`),c[`harness.pch`]=x,c[`harness.h`]=e),s.push(`main.c`,`-o`,`main.wasm`);let l;try{l=await v(s,c,{stdout:()=>{},stderr:e=>{e&&(a+=o.decode(e))}})}catch(e){return{success:!1,output:``,error:T(a)||e?.message||String(e)}}let f=l?.[`main.wasm`];if(!f||typeof f==`string`||!(f instanceof Uint8Array))return{success:!1,output:``,error:T(a)||`Compilation failed: no WebAssembly binary was generated.`};let p=``,_=``,y=new g(e=>{p+=o.decode(e)}),b=new g(e=>{_+=o.decode(e)}),w=new m(new h(new Uint8Array)),E=new d([`main.wasm`],[],[w,y,b]);try{let e=await WebAssembly.instantiate(f,{wasi_snapshot_preview1:E.wasiImport}),t=e.instance||e,n=0;try{E.start(t)}catch(e){if(e instanceof u)n=e.code;else throw e}let r=n===0;return{success:r,output:p,error:r?_||void 0:_||`Process exited with code ${n}`}}catch(e){return{success:!1,output:p,error:e?.message||String(e)}}},async lint(t){if(!t.trim())return[];try{await S();let n=!!x,r=C(t,``,!n),i=``,a=new TextDecoder(`utf-8`),o=[`clang`,`-fsyntax-only`,`-Wall`],s={"main.c":r};n&&x&&(o.push(`-include-pch`,`harness.pch`),s[`harness.pch`]=x,s[`harness.h`]=e),o.push(`main.c`);try{await v(o,s,{stdout:()=>{},stderr:e=>{e&&(i+=a.decode(e))}})}catch{}return w(i)}catch(e){return console.warn(`[C Worker Lint Error]:`,e),[]}},async reset(){y=!1,b=null,x=null,await S()}})})();